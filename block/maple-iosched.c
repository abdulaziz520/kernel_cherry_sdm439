...
/* Tunables */
static const int sync_read_expire = 60;	/* max time before a read sync is submitted. */
static const int sync_write_expire = 300;	/* max time before a write sync is submitted. */
static const int async_read_expire = 30;	/* ditto for read async, these limits are SOFT! */
