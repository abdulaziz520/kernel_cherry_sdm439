...
/* Tunables */
static const int sync_read_expire = 90;	/* max time before a read sync is submitted. */
static const int sync_write_expire = 5400;	/* max time before a write sync is submitted. */
static const int async_read_expire = 90;	/* ditto for read async, these limits are SOFT! */
static const int async_write_expire = 5400;	/* ditto for write async, these limits are SOFT! */
